                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                ...
                                @foreach($categories as $category)
                                    <tr class="gradeA" role="row">
                                        ...
                                        <td>{!! Form::open(['route'=>['category.destroy', $category], 'method'=>'DELETE']) !!}
                                            <div class="small-12 column">
                                                <button type="submit" class="btn btn-danger"><span class="fa fa-trash-o"></span> </button>
                                                 <a href="{{ route('CategoryProduct', $category->id) }}" class="btn btn-success"><span class="fa fa-shopping-basket"></span> </a>
                                                 <a href="{{ route('CategoryProducts', $category->id) }}" class="btn btn-info"><span class="fa fa-eye"></span> </a>
