        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    {!! Form::model($team, ['route'=>['department.update', $team->id], 'method'=>'PATCH', 'enctype'=>'multipart/form-data']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('description', null, ['placeholder'=>'Enter Department Description ', 'class'=>'form-control']) !!}
                    </div>

                    <div class="form-group">
                        {!! Form::label('skills[]', 'Select Skill') !!}
                        {!! Form::select('skills[]', $skills->pluck('name','id'), $team->skills, ['class' => 'select2 form-control', 'data-placeholder'=>'Select Group', 'multiple']) !!}
                    ...
                    <div class="form-group mt-20">
                        ...
                        <label class="switch">
                            {!! Form::checkbox('active', null, $team->active) !!}
                            <span class="slider round"></span>
                        </label>
                        <span class="help-block m-b-none">@if($team->active == 0) This Department is deactivated @else This Department is activated @endif</span>
