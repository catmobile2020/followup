            ...
            <div class="col-sm-8 col-sm-offset-2">
                <div class="post-topbar">
                    <div class="details">
                        ...
                        <textarea v-model="post.details" id="body" class="form-control" placeholder="What you are thinking about !"></textarea>
                    </div>
                ...
                user_id = $('#user_id').val();
                    ...
                    if (filesSelected.length > 0) {
                        ...
                        fileReader.onload = function(fileLoadedEvent) {
                            ...
                            if(!body || body == null){
                                $.post('/api/posts', {user_id: user_id, image: srcData}, function (data) {
                                    window.location.reload();
                                });
                            }else{
                                $.post('/api/posts', {user_id: user_id, image: srcData, body: body}, function (data) {
                                    window.location.reload();
                                });
                            }
                        ...
                        $.post('/api/posts', {user_id: user_id, body: body}, function (data) {
                            window.location.reload();
                        });
                    }
