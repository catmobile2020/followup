...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel-body">
                ...
                @endif
                    ...
                    <div class="cards-container box-view">
                        ...
                        @foreach($procurement->logs()->orderby('id', 'desc')->get() as $logs)
                            <div class="card bg-warning">
                                ...
                                <div class="card-header">
                                    <!-- Card short description -->
                                    <div class="card-short-description">
                                        <h5><span class="badge badge-bordered"><a href="#">{{ $logs->created_at }}</a></span></h5>
                                        <p>
                                            @foreach($logs->photos as $photo)
        ...
        {!! Form::open(['route'=>'ProcurementLog.store', 'method'=>'POST', 'files'=>true]) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::hidden('procurement_status', $procurement->status) !!}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('status', ['1'=>'Confirm', '0'=> 'Reject'], 1, ['class'=>'form-control']) !!}
                    </div>
